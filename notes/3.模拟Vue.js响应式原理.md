...
#### Dep(Dependency)
![Image text](https://github.com/zhanshancheng/fed-e-task-03-01/blob/master/notes/images/Dep.png)
  - 功能
    - 收集依赖，添加观察者（watcher）
    - 通知所有观察者
  - 结构
  ...
  - 代码(./minVue/js/dep.js)
#### Watcher(观察者)
![Image text](https://github.com/zhanshancheng/fed-e-task-03-01/blob/master/notes/images/Watcher.png)
  - 
  - 功能
